...
import (
	...
	"github.com/bgpat/reviewdog/service/commentutil"
)
...
func TestGitHubPullRequest_Post(t *testing.T) {
	...
	// https://github.com/bgpat/reviewdog/pull/2
	owner := "haya14busa"
	repo := "reviewdog"
	pr := 2
	...
	// https://github.com/bgpat/reviewdog/pull/2/files#diff-ed1d019a10f54464cfaeaf6a736b7d27L20
